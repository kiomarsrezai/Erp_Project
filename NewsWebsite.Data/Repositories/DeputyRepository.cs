...
namespace NewsWebsite.Data.Repositories
{
    public class DeputyRepository : IDeputyRepository
    {
        ...
        //public async Task<List<Proctor1ViewModel1>> GetAllDeputiesAsync(int yearId, int proctorId, int areaId, int budgetProcessId)
        //{
        ...
        //            {
        //                Proctor1ViewModel1 fetchView = new Proctor1ViewModel1();

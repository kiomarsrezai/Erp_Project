...
namespace NewsWebsite.Areas.Api.Controllers.v1
{
    ...
    public class ContractApiController : ControllerBase
    {
        ...
        public async Task<ApiResult<ResponseLayerDto>> ResponseSdi()
        {
            ...
            var request2 = new RestRequest("/geoserver/ows?service=wfs&version=1.0.0&request=GetFeature&typeName=ahvaz_kiosk14000719_8798&srsname=EPSG:4326&outputFormat=application/json&maxFeatures=500&startIndex=0&authkey=" + resplogin.api_key.ToString(), Method.Get);
